package Data
{
	...
	{
		public static var LessionTitle:Object = {
		...
		public static var LessionData:Object = {
			"17" : {
				"1" : { index:"I", text:"Quá trình hình thành và phát triển nhà nước phong kiến", color:0xA30505 },
				"2" : { index:"II", text:"Quá trình hình thành và phát triển nhà nước phong kiến", color:0xB31996 },
				"3" : { index:"III", text:"Quá trình hình thành và phát triển nhà nước phong kiến", color:0x020B70 },
				"4" : { index:"IV", text:"Quá trình hình thành và phát triển nhà nước phong kiến", color:0xE89300 }
			},
			"18" : {
				"1" : { index:"I", text:"Quá trình hình thành và phát triển nhà nước phong kiến", color:0xA30505 },
				"2" : { index:"II", text:"Quá trình hình thành và phát triển nhà nước phong kiến", color:0xB31996 },
		...
		public static var TNQuestions:Object	= {
			"17" : {
		...
		public static var DTData:Object	= {
			"17": {
			...
			"19": {
				...
				"3":"Cuộc kháng chiến chống quân xâm lược Mông Nguyên"
			},
			"20": {
				"1":"Chùa Phật Tích",
				"2":"Chùa Một Cột",
				"3":"Tác phẩm Hịch Tướng Sĩ Trần Hưng Đạo",
				"4":"Tác phẩm Bạch Đằng giang phú – Trương Hán Siêu"
			}
		};
		
		public static var TLQuestions:Object	= {
			"17" : {
